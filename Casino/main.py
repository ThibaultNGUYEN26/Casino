...
money_path = r'Python/Casino/res/money.txt'
history_path = r'Python/Casino/res/history.txt'
try:
			...
			while True:
				try:
					...
					if user_col_choice < 1 or user_col_choice > 3:
						...
						add_bet(bonus) if col in color[1::2] else sub_bet(bet)
						break
						...
						add_bet(bonus) if col in color[0::2] else sub_bet(bet)
						break
					else:
			...
			while True:
				try:
					...
					if user_par_choice < 1 or user_par_choice > 3:
						...
						add_bet(bonus) if nb in number[1::2] else sub_bet(bet)
						break
						...
						add_bet(bonus) if nb in number[0::2] else sub_bet(bet)
						break
					else:
						info_msg("Info", "Back to the menu.")
						break
				...
				try:
					...
					if user_sign_choice == 5:
						...
						if user_sign_choice == 1:
							...
							add_bet(bonus) if col in color[0] else sub_bet(bet)
							break
						if user_sign_choice == 2:
							...
							add_bet(bonus) if col in color[1] else sub_bet(bet)
							break
						if user_sign_choice == 3:
							...
							add_bet(bonus) if col in color[2] else sub_bet(bet)	
							break
						if user_sign_choice == 4:
							...
							add_bet(bonus) if col in color[3] else sub_bet(bet)
							break	
				except ValueError:
					info_msg("Error", "Type a valid number.")
	...
	def play():
		...
		while True:
			print(f"\n{WHITE}|* --------------------------------------- *|{EOC}")
			info_msg("Info", f"You have {money}$.")
			try:
